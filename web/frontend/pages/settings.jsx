...
export default function Settings() {
  ...
  const getSettings = () => {
    ...
    // console.log(AutopublishSetting, emailSetting, starIconColor, reviewListingLayout, reviewListingText, reviewFormText, BadgeText)
  }
  const resetSettings = () => {
  ...
  const test = () => {
    ...
    //   formData?.map((itm)=>{
    //     const array=(Object.keys(itm))
    //     let key =array.join(' ')
    //     // console.log(myString)
    //     // if (type.includes('autopublish')){
    //     //   console.log('here',(itm))
    //     // }
    //     // Object.keys(itm)
    //     if(key=='autopublish'){
    //       const data=Object.values(itm)
    //       console.log('autopublish data',data)
    //       // handleAutopublishSetting(data)
    //       setAutopublishSetting(data)
    //       // console.log(autopublish)
    //     }
    //     if(key=='emailSettings'){
    //       const data=Object.values(itm)
    //       console.log('email data',data)
    //       // setEmailSetting(data.map((itm)=>itm))
    //       handleEmailSetting(data.map((itm)=>{
    //         Object.keys(itm),Object.values(itm)
    //       }))
    //     }
    //   })
    // },[formData])

    // console.log(emailSetting.email)
        ...
        <Page >
          <BlockStack gap={400}>
            ...
            <InlineStack gap={300} align='end'>
              <Button size='large' onClick={()=>resetSettings()}> Reset all settings to default</Button>
